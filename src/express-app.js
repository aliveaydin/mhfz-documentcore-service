...
app.use("", documentVersionRouter);
app.use("", fileObjectRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "mhfz-documentCore-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="mhfz-documentCore-postman-collection.json"',
  );
